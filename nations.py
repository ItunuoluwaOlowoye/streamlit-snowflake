...
st.set_page_config(page_title='The New Nations Portal', page_icon=browser_tab_logo, layout='wide') # set the page layout

page_intro('The New Nations','Welcome to Nations. Please select your group below.')
...
stack1.markdown(html_dict['nation-pastors'], unsafe_allow_html=True)
stack2.markdown(html_dict['nations-pastor'], unsafe_allow_html=True)